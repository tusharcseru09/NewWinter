...
public class ErrorMessages {
	...
	public static final int UOM_KEY_MIN_LEN = 1;
	public static final int UOM_DESC_MIN_LEN = 2;
	public static final String PRODUCT_UOM_KEY_NOTBLANK = "Empty value not allowed";
	public static final String PRODUCT_UOM_DESC_NOTBLANK = "Empty value not allowed";
	public static final String PRODUCT_UOM_KEY_SIZE = "Character length must be " + UOM_KEY_MIN_LEN + " or above";
	public static final String PRODUCT_UOM_DESC_SIZE = "Character length must be " + UOM_DESC_MIN_LEN + " or above";

	
	
	public static final int PRODUCT_CODE_MIN_LEN = 2;
	public static final int PRODUCT_NAME_MIN_LEN = 2;
	public static final int PRODUCT_DESC_MIN_LEN = 2;
